...
describe('FinalizableToken Contract', () => {
      ...
      context('transfer function', async () => {
         ...
         context('sender = owner', async () => {
            ...
            it('transfer > balance to other account', async () => {
               ...
               await TestLib.assertCallFails(token.methods.transfer(account1, balance.plus(1)).call({ from: owner }))
            })
         ...
         context('sender = ops', async () => {
            ...
            it('transfer > balance to other account', async () => {
               ...
               await TestLib.assertCallFails(token.methods.transfer(account1, balance.plus(1)).call({ from: ops }))
            })
         ...
         context('sender = normal', async () => {
            ...
            it('transfer > balance to other account', async () => {
               ...
               await TestLib.assertCallFails(token.methods.transfer(account1, balance.plus(1)).call({ from: account1 }))
            })
      ...
      context('transferFrom function', async () => {
         ...
         context('sender = owner', async () => {
            ...
            it('transferFrom 10 while allowance is 10', async () => {
               ...
               assert.equal(balanceBefore.minus(balanceAfter).toString(), "10")
            })
            ...
            it('transferFrom 5 while allowance is 10', async () => {
               ...
               const balanceAfter = new BigNumber(await token.methods.balanceOf(account1).call())
               assert.equal(balanceBefore.minus(balanceAfter).toString(), "5")
            })
            ...
            it('transferFrom 10 + 10 + 1 while allowance is 20', async () => {
               ...
               assert.equal(balance1After.minus(balance1Before).toString(), "-20")
               assert.equal(balance3After.minus(balance3Before).toString(), "20")
            })
         })
      ...
      context('transfer function', async () => {
         ...
         context('sender = owner', async () => {
            ...
            it('transfer balance to other account', async () => {
               ...
               assert.equal(balance1After.minus(balance1Before), balanceOwnerBefore)
            })
         ...
         context('sender = normal', async () => {
            ...
            it('transfer > balance to other account', async () => {
               ...
               await TestLib.assertCallFails(token.methods.transfer(account2, balance.plus(1)).call({ from: account1 }))
            })
      ...
      context('transferFrom function', async () => {
         ...
         context('sender = normal ', async () => {
            ...
            it('transferFrom 10 + 10 + 1 while allowance is 20', async () => {
               ...
               const balance3After = new BigNumber(await token.methods.balanceOf(account3).call())
               assert.equal(balance1After.minus(balance1Before).toString(), "0")
   ...
   context('approve function', async () => {
      ...
      it('approve(other account, > balance)', async () => {
         ...
         Utils.checkApprove(await token.methods.approve(account1, 0).send({ from: owner }), owner, account1, 0)
         Utils.checkApprove(await token.methods.approve(account1, balance.plus(1)).send({ from: owner }), owner, account1, balance.plus(1))
         Utils.checkApprove(await token.methods.approve(account1, 0).send({ from: owner }), owner, account1, 0)
      })
